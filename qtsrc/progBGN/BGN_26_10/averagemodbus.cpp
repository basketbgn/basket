...
void AverageModbus::readBdgSensivity(uint8_t isotop)
{
    rs_485->ReadCommand(isotop);
}

float AverageModbus::getCurrentToropaSensivity()
{
    return rs_485->currentToropaSensibility;
}
