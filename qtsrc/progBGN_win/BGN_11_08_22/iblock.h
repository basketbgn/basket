...
public:
    ...
    float IblockCR_ResGamma{0};  //результирующая скорость счета в зависимости от давления и температуры
    void readBdgSensivity(uint8_t isotop);
    float getCurrentToropaSensivity();
private:
