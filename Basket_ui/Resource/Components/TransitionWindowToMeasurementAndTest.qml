...
Item {
    ...
    property alias secondName: secondNameField.text
    property alias windowTitle: titleLabel.text
    property alias needTestPassed: measurementButton.needTestPassed
    property alias isTestPassed: measurementButton.isTestPassed

    signal hardwareTestButtonClicked()
    signal measurementButtonClicked()
    signal backButtonClicked()

    signal nameWasChanged(string name)
    signal secondNameWasChanged(string secondName)
    signal surnameWasChanged(string surname)
    ...
    StatusBar {
        ...
        Label {
            ...
            font.pixelSize: transitionWindow.height/50
            font.bold: true
            color: "#eeeeee"
            text: qsTr("Заголовок")
        }
    ...
    Text {
        ...
        anchors.horizontalCenter: parent.horizontalCenter
        anchors.top: transitionWindowStatusBar.bottom
    ...
    CustomButton {
        ...
        buttonText: qsTr("Тест аппаратуры")
        onButtonClicked: {
            hardwareTestButtonClicked()
        }
    }
